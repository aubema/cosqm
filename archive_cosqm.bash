...
y=`/bin/date -u +%Y`
mo=`/bin/date -u +%m`
cosqm_addr=(192.168.0.100 161.72.128.52 vpn.izana.org:5080 193.146.80.130:5180 161.72.10.154:5380 147.96.71.44:5080)
cosqm_name=(Saint-Camille Observatorio_Teide Santa-Cruz_Tenerife Pico_Teide Izana_AEMET UCMadrid)
